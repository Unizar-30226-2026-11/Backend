...
const gameStateSchema = new Schema('game_state', {
  ...
  // Para las casillas del tablero (JSON: Record<number, string[]>)
  boardRegistry: { type: 'string' },

  // Modificadores temporales (JSON: Record<string, ModifierData>)
  activeModifiers: { type: 'string' },

  // Semáforo para bloquear el juego durante un conflicto
