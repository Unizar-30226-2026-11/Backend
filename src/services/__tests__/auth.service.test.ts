...
describe('AuthService - Pruebas Funciones', () => {
    ...
    describe('Registrar Usuario. -> registerUser() ', () => {
        ...
        test('Registro Correcto:', async () => {
            ...
            const resultado = await AuthService.registerUser(email_test, username_test, password_test);
    ...
    describe('Buscar Usuario. -> findUserByEmailOrUsername() ', () => {
        ...
        test('Usuario Existente:', async () => {
            ...
            const resultado = await AuthService.findUserByEmailOrUsername("jugador1@ejemplo.com", "Jugador1");
        ...
        test('Usuario Inexistente:', async () => {
            ...
            const resultado = await AuthService.findUserByEmailOrUsername("jugadorFalso@test.com", "saltaError");
    ...
    describe('Inicio de Sesion Usuario. -> loginUser() ', () => {
        ...
        test('Usuario Inexistente:', async () => {
            ...
            const resultado = await AuthService.loginUser("jugadorFalso@test.com", "saltaError");
