...
describe('UserService - Pruebas Funciones', () => {
    ...
    beforeAll( async () => {
        ...
        for (let i = 0; i < 5; i++){
            let cartas_mazo_prueba = ["c_1", "c_2", "c_3", "c_4", "c_5", "c_6", "c_7", "c_8"];
            const resultado = await UserService.createDeck("u_1", "De Prueba", cartas_mazo_prueba);
                ...
                test('Usuario Existente:', async () => {
                    ...
                    expect(resultado).toEqual(
                        expect.objectContaining({
                            ...
                            state: expect.stringMatching(/^(DISCONNECTED|CONNECTED|UNKNOWN|IN_GAME)$/),
                            personal_state: resultado?.personal_state === null ? null : expect.any(String), 
    ...
    describe('Sistema de Mazos. ', () => {
        ...
        describe('Creacion de Mazos. -> createDeck() ', () => {
            ...
            test('Campos Incorrectos:', async () => {
                ...
                await expect(UserService.createDeck("u_99", "", cartas_mazo_prueba)).rejects.toThrow();                
            });
        });
        ...
        describe('Actualización de Mazos. -> updateDeck() ', () => {
            ...
            test('Un solo mazo cambiado con éxito:', async () => {
                ...
                let cartas_mazo_prueba = ["c_3", "c_2", "c_7", "c_6", "c_8", "c_4", "c_1", "c_5"];
                const resultado = await UserService.updateDeck(id_deck_created,"De Prueba Reorganizado", cartas_mazo_prueba)
            ...
            test('Varios mazos cambiados con éxito:', async () => {
                ...
                let cartas_mazo_prueba = ["c_12", "c_11", "c_10", "c_9", "c_8", "c_7", "c_6", "c_5", "c_4", "c_3", "c_2", "c_1"];
                let mazos_a_cambiar = ["d_1", "d_2", "d_3", "d_4"];
                const resultado = await UserService.updateDeck(mazos_a_cambiar,"De Prueba Reorganizado", cartas_mazo_prueba)
            ...
            test('Campos Incorrectos:', async () => {
                ...
                await expect(UserService.updateDeck("u_99", "", cartas_mazo_prueba)).rejects.toThrow(); 
            });
        });
    ...
    afterAll( async () => {
        ...
        let cartas_mazo_prueba = ["c_1", "c_2", "c_3", "c_4", "c_5", "c_6", "c_7", "c_8", "c_9", "c_10", "c_11", "c_12"];
        let mazos_a_cambiar = ["d_1", "d_2", "d_3", "d_4"];
        await UserService.updateDeck(mazos_a_cambiar,"Mazo Principal de JugadorX", cartas_mazo_prueba);
    })
